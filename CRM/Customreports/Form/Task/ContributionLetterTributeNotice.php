 ...
 */
class CRM_Customreports_Form_Task_ContributionLetterTributeNotice extends CRM_Customreports_Form_Task_ContributeBase {

  protected $templateName = 'ContributionLetterTributeNotice';

  protected $templateTitle = 'Contribution Letter - Notice of Tribute';
